...
```
docker run -v $(pwd):/data --rm -it quay.io/comparative-genomics-toolkit/cactus:v2.4.3 cactus /data/jobStore /data/evolverMammals.txt /data/evolverMammals.hal --root mr
```
