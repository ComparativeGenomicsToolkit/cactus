...
def run_cactus_align(job, configWrapper, cactusWorkflowArguments, project, checkpointInfo, doRenaming, pafInput, pafSecondaries, doVG, doGFA, delay=0,
                     eventNameAsID=False, acyclicEvent=None, pafMaskFilter=None):
    ...
    preprocess_job = head_job.addChildJobFn(preprocess_input_sequences, project, cactusWorkflowArguments, pafMaskFilter)
...
def preprocess_input_sequences(job, project, cactusWorkflowArguments, pafMaskFilter=None):
