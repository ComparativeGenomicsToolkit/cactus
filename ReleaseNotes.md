...
- hal2vg and its tools (clip-vg, halRemoveDupes, halMergeChroms, halUnclip, filter-paf-deletions) are now built from a pinned commit in `downloadPangenomeTools` instead of downloaded from a hal2vg release.
