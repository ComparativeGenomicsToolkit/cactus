...
```
tar -xzf cactus-bin-v3.2.0.tar.gz
cd cactus-bin-v3.2.0
```
...
```
virtualenv -p python3 venv-cactus-v3.2.0
printf "export PATH=$(pwd)/bin:\$PATH\nexport PYTHONPATH=$(pwd)/lib:\$PYTHONPATH\nexport LD_LIBRARY_PATH=$(pwd)/lib:\$LD_LIBRARY_PATH\n" >> venv-cactus-v3.2.0/bin/activate
source venv-cactus-v3.2.0/bin/activate
