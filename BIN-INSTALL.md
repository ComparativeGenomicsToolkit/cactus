...
```
tar -xzf cactus-bin-v2.8.2.tar.gz
cd cactus-bin-v2.8.2
```
...
```
virtualenv -p python3 venv-cactus-v2.8.2
printf "export PATH=$(pwd)/bin:\$PATH\nexport PYTHONPATH=$(pwd)/lib:\$PYTHONPATH\n" >> venv-cactus-v2.8.2/bin/activate
source venv-cactus-v2.8.2/bin/activate
