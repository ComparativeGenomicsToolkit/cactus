...
```
tar -xzf cactus-bin-v2.7.1.tar.gz
cd cactus-bin-v2.7.1
```
...
```
virtualenv -p python3 venv-cactus-v2.7.1
printf "export PATH=$(pwd)/bin:\$PATH\nexport PYTHONPATH=$(pwd)/lib:\$PYTHONPATH\n" >> venv-cactus-v2.7.1/bin/activate
source venv-cactus-v2.7.1/bin/activate
