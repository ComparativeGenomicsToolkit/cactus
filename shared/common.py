...
def runCactusCaf(cactusDiskDatabaseString, alignments, 
    ...
    maximumRedundantFraction = nameValue("maximumRedundantFraction", maximumRedundantFraction)
