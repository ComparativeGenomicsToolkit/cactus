...
def runCactusCaf(cactusDiskDatabaseString, alignments, 
                  ...
                  numAlignmentsPerBatch=None,
                  maxRedundantFraction=None):
    logLevel = getLogLevelString2(logLevel)
    ...
    numAlignmentsPerBatch = nameValue("numAlignmentsPerBatch", numAlignmentsPerBatch, int)
    maxRedundantFraction = nameValue("maxRedundantFraction", maxRedundantFraction, float)
    ...
    command = "cactus_caf --cactusDisk '%s' --logLevel %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s" % \
    (cactusDiskDatabaseString, logLevel, alignments, annealingRounds, deannealingRounds, 
     ...
     maxRedundantFraction, numAlignmentsPerBatch)
