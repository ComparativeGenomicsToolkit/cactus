...
${binPath}/cactus_core : *.cc *.c *.h ${libPath}/sonLib.a ${libPath}/sonLibPlus.a ${libPath}/xmlLib.a
	...
	${cyy} ${cpflags} -I ${libPath} -o ${binPath}/cactus_core cactus_core.cc pinchGraph.o pinchGraphTest.o pinchGraphManipulation.o net.o cactusGraph.o reconstructionTree.cc reconstructionTreeTest.cc ${libPath}/sonLib.a ${libPath}/sonLibPlus.a ${libPath}/xmlLib.a
	rm *.o
