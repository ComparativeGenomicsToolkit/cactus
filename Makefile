...
${binPath}/cactus_core : *.cc *.c *.h ${libPath}/sonLib.a ${libPath}/sonLibPlus.a ${libPath}/xmlLib.a
	${cxx} ${cflags} -I ${libPath} -c pinchGraph.c pinchGraphTest.c pinchGraphManipulation.c net2.c netSerialisation.c cactusNetFunctions.c net.c cactusGraph.c ${libPath}/sonLib.a 
	${cyy} ${cpflags} -I ${libPath} -o ${binPath}/cactus_core cactus_core.cc pinchGraph.o pinchGraphTest.o pinchGraphManipulation.o net2.o netSerialisation.o cactusNetFunctions.o net.o cactusGraph.o reconstructionTree.cc reconstructionTreeTest.cc ${libPath}/sonLib.a ${libPath}/sonLibPlus.a ${libPath}/xmlLib.a
	rm *.o
