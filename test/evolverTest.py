...
class TestCase(unittest.TestCase):
    ...
    def testEvolverLocal(self):
        ...
        self._check_maf_accuracy(self._out_hal(name), delta=(0.045, 0.12))
    ...
    def testEvolverPrepareWDL(self):
        ...
        self._check_maf_accuracy(self._out_hal("wdl"), delta=(0.045, 0.12))
    ...
    def testEvolverDocker(self):
        ...
        self._check_maf_accuracy(self._out_hal("docker"), delta=(0.045, 0.12))
    ...
    def testEvolverInDocker(self):
        ...
        #self._check_stats(self._out_hal("docker"), delta_pct=0.25)
        #self._check_coverage(self._out_hal("docker"), delta_pct=0.20)
        self._check_maf_accuracy(self._out_hal("in_docker"), delta=(0.045, 0.12))
