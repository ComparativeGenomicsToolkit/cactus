...
static void facesSetup() {
    ...
    if (net_getFirstFace(net) == face2) { //switch round, because we have no guarantted order for faces..
        Face *face3 = face2;
        face2 = face;
        face = face3;
    }
...
static void testObjectRetrieval(CuTest* testCase, void(*setupFn)(),
        int32_t(*getObjectNumberFn)(Net *net), void *(*getFirstObjectFn)(
                Net *net), Name(*objectGetNameFn)(void *),
        void *(*getObjectFn)(Net *net, Name name), void *(*constructIterator)(
                Net *net), void(*destructIterator)(void *iterator),
...
void testNet_cap(CuTest* testCase) {
    testObjectRetrieval(testCase, capsSetup,
            ...
            (void *(*)(Net *)) net_getFirstCap, (Name(*)(void *)) cap_getName,
            ...
            (void *(*)(void *)) net_copyCapIterator, (void **) (&cap),
            (void **) (&cap2));
}
...
void testNet_end(CuTest* testCase) {
    testObjectRetrieval(testCase, endsSetup,
            ...
            (void *(*)(Net *)) net_getFirstEnd, (Name(*)(void *)) end_getName,
            ...
            (void *(*)(void *)) net_copyEndIterator, (void **) (&end),
            (void **) (&end2));
}
...
void testNet_segment(CuTest* testCase) {
    testObjectRetrieval(testCase, segmentsSetup,
            ...
            (void *(*)(void *)) net_copySegmentIterator, (void **) (&segment),
            (void **) (&segment2));
}
...
void testNet_block(CuTest* testCase) {
    testObjectRetrieval(testCase, blocksSetup,
            ...
            (void *(*)(void *)) net_copyBlockIterator, (void **) (&block),
            (void **) (&block2));
}
...
void testNet_chain(CuTest* testCase) {
    testObjectRetrieval(testCase, chainsSetup,
            ...
            (void *(*)(void *)) net_copyChainIterator, (void **) (&chain),
            (void **) (&chain2));
}
...
void testNet_group(CuTest* testCase) {
    testObjectRetrieval(testCase, groupsSetup,
            ...
            (void *(*)(void *)) net_copyGroupIterator, (void **) (&group),
            (void **) (&group2));
}
