...
int database_constructP(const char *vA1, int size1, const char *vA2, int size2,
        void *a) {
...
int32_t database_writeRecord(TCBDB *database, Name key, const void *value,
        int32_t sizeOfRecord) {
    int32_t ecode;
