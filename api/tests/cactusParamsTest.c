...
static void testCactusParams(CuTest *testCase) {
    ...
    CuAssertStrEquals(testCase, "--step=1 --ambiguous=iupac,100,100 --ydrop=4000 --hspthresh=2200 --gappedthresh=2400 --queryhspbest=100000", c);
    ...
    CuAssertDblEquals(testCase, 0.1, d, 0.000001);
